...
using namespace std;
int main(){
  //Keyword are reserved by the language and cannot be used as identifiers
  int myVariable=20;//'int' is a keyword, 'myVariable'is an identifier  
  float anotherVariable=10.5f;//'float'is a keyword, 'anotherVariable'is an identifier 
